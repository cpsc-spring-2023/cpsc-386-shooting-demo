    ...
    def update_scene(self):
        ...
        for bullet in self._bullets:
            ...
            if bullet.should_die():
                ...
                index = bullet.rect.collidelist([c.rect for c in self._circles])
                if index > -1:
                    Explosion(self._circles[index])
                    self._circles[index].is_exploding = True
                    self._circles.remove(self._circles[index])
